...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
      ...
      _______, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,      _______, _______,      _______, _______, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT, _______,
                            _______, _______,  LA_NAVIGATE, KC_SPACE, LA_NUMBERS,      _______,  KC_BSPC, LA_SYMBOLS,  _______, _______
    ),
    [NAVIGATE] = LAYOUT(
      _______, KC_ENT,  KC_TAB,  KC_SPC,  KC_BSPC, KC_DEL,                                          KC_NO,  MC_WORD_LEFT, KC_NO, MC_WORD_RIGHT, KC_NO, _______,
      _______, OS_SHFT, OS_CTRL, OS_ALT,  OS_CMD,  KC_NO,                                     MC_LINE_START, KC_LEFT,     KC_UP,  KC_RGHT,    MC_LINE_END, _______,
    ...
    [SYMBOLS] = LAYOUT(
      ...
      _______, KC_AT,   KC_LPRN, KC_RPRN, KC_HASH, KC_DLR,                                          KC_NO,   KC_UNDS, KC_QUES, KC_EXLM, SE_ODIA, _______,
      _______, KC_NO,   KC_LBRC, KC_RBRC, KC_NO,   KC_NO,   _______, _______,     _______, _______, KC_NO,   KC_NO,   KC_SCLN, KC_COLN, KC_DQUO,  _______,
                                 _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______
    ),
    [NUMSYM] = LAYOUT(
      _______, KC_SPACE,KC_7,    KC_8,    KC_9,    KC_NO,                                                KC_J,    KC_SLSH, KC_BSLS, KC_ASTR, KC_TILD,   _______,
      _______, KC_0,    KC_4,    KC_5,    KC_6,    KC_LABK,                                              KC_RABK, KC_MINS, KC_EQL,  KC_PLUS, KC_CIRC, _______,
      _______, KC_NO,   KC_1,    KC_2,    KC_3,    KC_NO,    _______, _______,         _______, _______, KC_NO,   KC_E,   KC_COMM, KC_DOT,  KC_GRAVE,   _______,
                                 _______, _______, _______,  _______,  _______,        _______, _______, _______, _______, _______
    ),
    [NUMFUNC] = LAYOUT(
      _______, KC_NO,   KC_7,    KC_8,    KC_9,    KC_NO,                                                KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,
      _______, KC_0,    KC_4,    KC_5,    KC_6,    KC_LABK,                                              KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
      _______, KC_NO,   KC_1,    KC_2,    KC_3,    KC_NO,    _______, _______,         _______, _______, KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  _______,
                                 _______, _______, _______,  _______,  _______,        _______, _______, _______, _______, _______
    ),
   [META] = LAYOUT(
      _______, OSTOGG_SHOW,OSTOGG_WINDOWS,OSTOGG_MACOS,OSTOGG_LINUX,   _______,                     _______,  _______,  _______,  _______,  _______,  _______,
      _______, KC_NO,   KC_VOLD, KC_MUTE, KC_VOLU, _______,                                         _______,  _______,  _______,  _______,  _______,  _______,
      _______, KC_NO,   KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______,     _______, _______, _______,  _______,  _______,  _______,  _______,  _______,
                                 _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______
    ),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    state = update_tri_layer_state(state, SYMBOLS, NAVIGATE, NUMSYM);
    state = update_tri_layer_state(state, SYMBOLS, NUMFUNC, META);
    return state;
}
