...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
      ...
      _______, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,      _______, _______,      _______, _______, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT, _______,
                            _______, _______,  LA_NAVIGATE, SPACE_NUMBERS, _______,      _______,  KC_BSPC, LA_SYMBOLS,  _______, _______
    ),

    [NUMBERS] = LAYOUT(
      _______, KC_NO,   KC_7,    KC_8,    KC_9,    KC_E,                                                 KC_J,    KC_SLSH, KC_BSLS, KC_ASTR, KC_TILD,   _______,
    ...
    [SYMBOLS] = LAYOUT(
      ...
      _______, KC_NO,   KC_LBRC, KC_RBRC, KC_NO,   KC_NO,   _______, _______,     _______, _______, KC_NO,   KC_NO,   KC_SCLN,   KC_COLN,   KC_NO,   _______,
                                 _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______
    ),
   [FUNCTION] = LAYOUT(
      _______, OSTOGG_SHOW,OSTOGG_WINDOWS,OSTOGG_MACOS,OSTOGG_LINUX,   _______,                     KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,
...
const uint16_t PROGMEM combo_dualthumb[] = {SPACE_NUMBERS, KC_BSPC, COMBO_END};
